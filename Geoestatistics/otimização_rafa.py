...
def em_tstudent_spatial(X, Y, gr, theta_init, H, k, gl, max_iter=100, tol=1e-4):
    """
...
while True:
    ...
    em_resultados = em_tstudent_spatial(X, Y, gr, theta_init=[*beta_ols.flatten(), phi1, phi2, phi3], H=H, k=k, gl=gl)
